...
namespace Perso002_Test
{
    class Program
    {
        static void CentrerEncadrerTitre(string str_Titre, char chr_CarSouligne)            // Méthode CentrerEncadrerTitre
        {
        ...
        static void EffacerEcrireEcran(int int_Vies, int int_ScoreAct, int int_BestScore)   // Méthode EffacerEcrireEcran
        {
            int i, j;
        ...
        static void Main(string[] args)
        {
            ...
            string str_Titre;
            char chr_CarSouligne, chr_Rep, chr_Boule;
            char[] tab_chrVies = new char[5];
